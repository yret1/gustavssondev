  ...
  return (
    ...
    >
      ...
      <section className="w-screen flex justify-center items-center flex-col">
        ...
        <p>
          Together we will explore you&apos;r idea and shape it into the prodoct
          you need. Check out some of my services down below!
        </p>
      </section>
      ...
      <section className="grid w-screen lg:grid-cols-5 gap-8 p-4 md:p-24 place-items-center">
        <a
          ...
          href="#contact"
          className={`w-full h-full group md:col-span-2`}
        >
          ...
          <article className="flex h-full w-full flex-col border-2 rounded-lg justify-between bg-[#0C1021] p-8">
            <section>
              ...
              <p className="mb-8 max-w-prose text-pretty text-sm text-white text-opacity-70">
                ...
                for you or your company. Helping your business enter the modern
                website age!
              </p>
            </section>
            <section className="w-full h-full flex gap-2 flex-col justify-start items-start">
              ...
              <Checkbox
                text="Hosting (including domain setup)  + $ 100 (Only hosting $ 50)"
                checked={false}
              />

              <Checkbox text="Analytics   + $ 20" checked={false} />
            </section>
          ...
          <article className="flex h-full w-full flex-col border-2 rounded-lg justify-between bg-[#0C1021] p-8">
            <section>
              ...
              <p className="mb-8 max-w-prose text-pretty text-sm text-white text-opacity-70">
                ...
                Upwork, a freelance platform. The reason being simpler and safer
        ...
        >
          <article className="flex h-full w-full flex-col border-2 rounded-lg justify-between bg-[#0C1021] p-8">
            <section>
              ...
              <p className="mb-8 max-w-prose text-pretty text-sm text-white text-opacity-70">
                In the case that your project doesn&apos;t fit any of the
                choices provided or you have questions regarding what I can do
                for you, Lets chat and we will figure the scope of your project
                out!
              </p>
            </section>
            <section className="w-full h-full flex gap-2 flex-col justify-start items-start">
