...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="w-screen relative flex flex-col lg:flex-row bg-slate-900"
    >
      ...
      <section className="flex-1 flex flex-col justify-start items-start p-4 lg:py24">
        ...
        >
          <fieldset className="flex flex-col gap-2 w-full lg:w-8/12">
            <label
              htmlFor="name"
              className="text-2xl text-white text-opacity-30"
            >
              NAME
            </label>
            <input
          ...
          <button className="w-8/12 bg-purp py-5 text-2xl rounded-md border-2 border-purp transition-all duration-300 hover:border-white">
            {result}
          </button>
        </form>
      </section>
